...
from ReoMusic.utils.decorators.admins import ActualAdminCB
from ReoMusic.utils.decorators.language import language, languageCB
from ReoMusic.utils.inline.settings import (
...
from ReoMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://telegra.ph/file/45e8567d0dbba5f8afe5a.mp4"),
